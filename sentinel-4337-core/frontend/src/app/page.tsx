                ...
                <div>
                  ...
                  <div className="flex items-end gap-3">
                    <span className={`text-5xl font-black transition-colors duration-500 ${
                      healthFactorDisplay !== null && healthFactorDisplay !== "∞" && parseFloat(healthFactorDisplay) < 3.0
                        ? "text-red-500"
                        : "text-emerald-600"
                    }`}>
                    ...
                    <span className={`text-sm font-medium mb-2 transition-colors duration-500 ${
                      ...
                      {healthFactorDisplay !== null && healthFactorDisplay !== "∞" && parseFloat(healthFactorDisplay) < 3.0 ? "[AT RISK]" : "[SAFE]"}
                    </span>
                  </div>
                </div>
